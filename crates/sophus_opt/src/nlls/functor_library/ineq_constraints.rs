...
pub mod half_plane;
/// Maximum velocity inequality constraint between consecutive SE(3) poses.
...
/// Segment-sphere obstacle inequality constraint for pairs of SE(3) poses.
pub mod segment_sphere_obstacle;
/// Sphere obstacle inequality constraint for SE(3) poses.
pub mod sphere_obstacle;
pub use half_plane::HalfPlaneConstraint;
pub use max_velocity::MaxVelocityConstraint;
pub use scalar_circle::{
    ScalarCircleConstraint,
    ScalarCircleInsideConstraint,
};
...
pub use segment_sphere_obstacle::SegmentSphereObstacleConstraint;
pub use sphere_obstacle::SphereObstacleConstraint;

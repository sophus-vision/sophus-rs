...
//     pub fn triangular_solve_in_place(&self, b: &mut BlockVector, triangle: Triangular, op:
// MultOp) {         match (op, triangle) {
...
//                                                                                        * x */
//             // = b
//             (MultOp::Transpose, Triangular::Upper) => self.solve_upper_transpose(b), /* solve Uᵗ
// x = b */         }
//     }

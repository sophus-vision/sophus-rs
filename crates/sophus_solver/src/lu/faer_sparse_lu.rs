...
/// Numeric factorization result for the faer sparse LU solver.
#[derive(Clone, Debug)]
...
impl IsLinearSolver for FaerSparseLu {
        ...
        match mat_a.square.sp_lu() {
            ...
            Err(e) => Err(LinearSolverError::FaerSparseLuError {
                faer_error: match e {
                    ...
                    LuError::SymbolicSingular { .. } => FaerSparseSolverError::SymbolicSingular,
                },
            }),
        }
    }
    ...
    fn zero(&self, partitions: PartitionSet) -> SymmetricMatrixBuilderEnum {
        SymmetricMatrixBuilderEnum::FaerSparse(
            ...
            LinearSolverEnum::FaerSparseLu(*self),
        )
    }

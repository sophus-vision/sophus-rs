...
impl LdltTracer for AsciiTracer {
    #[inline]
    ...
    fn after_update(
        ...
        let (i, j, k) = (indices.i, indices.j, indices.k);
        println!(
    ...
    #[inline]
    fn after_append_and_sort(&mut self, _j: usize, l_storage: &LStorage, d: &[f64]) {
...
fn main() {
    ...
    let lower_mat_a = CscMatrix::from_triplets(&builder.build());

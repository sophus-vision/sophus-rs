...
pub(crate) fn get_adjusted_view_size(view_aspect_ratio: f32, max_width: f32, max_height: f32) -> (f32, f32) {
    let view_width = max_width.min(max_height * view_aspect_ratio);
    let view_height = max_height.min(max_width / view_aspect_ratio);

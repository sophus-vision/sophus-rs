use crate::calculus::dual::vector::HasJacobian;
use crate::calculus::dual::vector::VectorValuedDerivative;
...
fn vector_valued_map_from_vector_tests() {
    ...
    use crate::calculus::maps::vector_valued_maps::VectorValuedMatrixMap;

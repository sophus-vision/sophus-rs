...
pub struct SpiralSimilarity2Impl<S: IsScalar<BATCH_SIZE>, const BATCH_SIZE: usize> {
    phanton: PhantomData<S>,
}

impl<S: IsScalar<BATCH_SIZE>, const BATCH_SIZE: usize> SpiralSimilarity2Impl<S, BATCH_SIZE> {}

impl<S: IsScalar<BATCH_SIZE>, const BATCH_SIZE: usize> ParamsImpl<S, 2, BATCH_SIZE>
    for SpiralSimilarity2Impl<S, BATCH_SIZE>
{
...
impl<S: IsScalar<BATCH_SIZE>, const BATCH_SIZE: usize>
    ...
    for SpiralSimilarity2Impl<S, BATCH_SIZE>
{
    type GenG<S2: IsScalar<BATCH_SIZE>> = SpiralSimilarity2Impl<S2, BATCH_SIZE>;
    type RealG = SpiralSimilarity2Impl<S::RealScalar, BATCH_SIZE>;
    type DualG = SpiralSimilarity2Impl<S::DualScalar, BATCH_SIZE>;
...
// TODO: Complete the implementation of IsRealLieGroupImpl trait for SpiralSimilarity2Impl
impl<S: IsRealScalar<BATCH_SIZE>, const BATCH_SIZE: usize>
    IsRealLieGroupImpl<S, 2, 2, 2, 2, BATCH_SIZE> for SpiralSimilarity2Impl<S, BATCH_SIZE>
{
...
pub type SpiralSimilarity2<S, const B: usize> =
    LieGroup<S, 2, 2, 2, 2, B, SpiralSimilarity2Impl<S, B>>;

impl<S: IsScalar<BATCH_SIZE>, const BATCH_SIZE: usize> IsLieFactorGroupImpl<S, 2, 2, 2, BATCH_SIZE>
    for SpiralSimilarity2Impl<S, BATCH_SIZE>
{
    type GenFactorG<S2: IsScalar<BATCH_SIZE>> = SpiralSimilarity2Impl<S2, BATCH_SIZE>;
    type RealFactorG = SpiralSimilarity2Impl<S::RealScalar, BATCH_SIZE>;
    type DualFactorG = SpiralSimilarity2Impl<S::DualScalar, BATCH_SIZE>;
...
// TODO: Complete the implementation of IsRealLieFactorGroupImpl trait for SpiralSimilarity2Impl
impl<S: IsRealScalar<BATCH_SIZE>, const BATCH_SIZE: usize>
    IsRealLieFactorGroupImpl<S, 2, 2, 2, BATCH_SIZE> for SpiralSimilarity2Impl<S, BATCH_SIZE>
{
